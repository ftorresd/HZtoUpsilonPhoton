...
# execString="ana_ZtoUpsilonPhoton(getFilesList(\"filesLists/filesFromUERJPOWER/HZtoUpsilonPlusPhotonSamples2016_withGhostCleanning/ZToUpsilon1SGamma.txt\"), ${totalEvts}, \"ZToUpsilon1SGamma\", true, \"puWeight/puWeights_ZToUpsilon1SGamma.root\");"
# run_Ana="${run_Ana_template/___EXECSTRING___/$execString}" 
...
# execString="ana_ZtoUpsilonPhoton(getFilesList(\"filesLists/filesFromUERJPOWER/HZtoUpsilonPlusPhotonSamples2016_withGhostCleanning/HToJPsiGamma.txt\"), -1, \"HToJPsiGamma\", true, \"puWeight/puWeights_ZToJPsiGamma.root\");"
# run_Ana="${run_Ana_template/___EXECSTRING___/$execString}" 
