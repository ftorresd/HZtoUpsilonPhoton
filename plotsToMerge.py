...
for sample in samplesData:
	for shape in shapeSystMasksData:
		...
		print "mv outputHistos/outTreeUpsilonControlSample_HZtoUpsilonPhoton_"+sample[0]+"_"+sample[1]+"_"+sample[2]+"_ZZZZZZ_"+shape+".root outputHistos/outTreeUpsilonControlSample_HZtoUpsilonPhoton_"+sample[0]+"_"+sample[1]+"_"+sample[2]+"_ZZZZZZ.root\n"
